...
@section('content')
    ...
    <x-admin.card.default>
        <x-admin.form.edit action="{{ route('test-standart.update',$data) }}" >
            <x-admin.form.input class="col-12 mb-5" label="Nama" name="name" type="text" value="{{$data->name}}" required />
            <x-admin.form.input class="col-6 mb-5" label="Number" name="number" type="number" value="{{$data->number}}" required />
